...
# 输入文件夹路径
INPUT_DIR="/remote-home1/yli/Workspace/R3RAG/data/construct/mainv9/sample/2wikimultihopqa/train"
# 输出文件夹路径
OUTPUT_DIR="/remote-home1/yli/Workspace/R3RAG/data/construct/mainv9/merge/2wikimultihopqa/train"
